...
| openKeyboardMargin        | number   | keyboardHeight   | openKeyboardMargin={50}                 | In case you have set enableModalAvoiding = {true} you can adjust how much you want the modal to rise above keyboard the default value for this will be the keyboard height itself      |
